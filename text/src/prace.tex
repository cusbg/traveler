...
Tie neboli formalizované a~tak tento problém obchádzame novým algoritmom
schopným vizualizovať RNA sekundárnu štruktúru pomocou podobnej štruktúry
s~existujúcim nakreslením. RNA prevedieme do stromovej reprezentácie,
