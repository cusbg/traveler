...
(miRNA, siRNA, snRNA, snoRNA a ďalšie) \citenum{RNA_MI_SI} \citenum{RNA_SN_SNO},
...
štruktúry \citenum{JVIZ}: spojnicový graf (linked graph), kruhový graf (circular graph)
...
RNAfold z balíka ViennaRNA \citenum{VIENNA_RNA}, VARNA \citenum{VARNA},
...
Porovnanie všetkých (až na mfold) nájdeme v článku \citenum{DRAWING_COMPARISION}.
